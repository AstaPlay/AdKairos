  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Orbit,
        subItems: [
          { id: "orion-whatsapp", title: "WhatsApp", url: "/dashboard/orion/whatsapp", icon: MessageCircle },
          { id: "orion-atendimento", title: "Atendimento", url: "/dashboard/orion/atendimento", icon: MessagesSquare },
          { id: "orion-instagram", title: "Instagram", url: "/dashboard/orion/instagram", icon: Camera },
          { id: "orion-ads", title: "Ads", url: "/dashboard/orion/ads", icon: Target },
          { id: "orion-super-cerebro", title: "Super Cérebro", url: "/dashboard/orion/super-cerebro", icon: Sparkles },
          { id: "orion-integracoes", title: "Integrações", url: "/dashboard/orion/integracoes", icon: Link2 },
        ],
      },
      {
        id: "catalogo",
